const CapitalWealth = () => {
    return ( 
        <main className="min-w-[18rem] w-1/2 bg-[#EBEBF52E] border border-[#7676801F] p-4 hover:bg-[#FBF1EC] duration-500 rounded-lg cursor-pointer">
            ...
            <p className="text-[10px] lg:text-[12px] text-[#B2B3BA] my-3">Lock up funds at up to 15% APY. Withdraw up to 15% of principal per year penalty-free.</p>
