        ...
        <main>
            <div className="py-8 flex justify-between items-center text-[#F2F2F7] font-medium text-xs sm:text-sm xl:text-base">
                <div className="flex gap-x-5 lg:gap-x-10 items-center">
                    ...
                    <Link href="features" className="hidden md:block hover:text-primary duration-500" prefetch={true}>Features</Link>
                    <Link href="aboutus" className="hidden md:block hover:text-primary duration-500" prefetch={true}>About us</Link>
                    <Link href="contactus" className="hidden md:block hover:text-primary duration-500" prefetch={true}>Contact us</Link>
                </div>
            ...
            <div className={`${!isOpen && "hidden"} lg:hidden fixed h-screen w-full bg-black bg-opacity-70 z-[700] top-0 left-0`} onClick={toggleOpen}>
                ...
                {isOpen && (
                  ...
                  >
                    <Link href="features" className="text-secondary hover:text-primary duration-500" prefetch={true}>Features</Link>
                    <Link href="aboutus" className="hover:text-primary duration-500" prefetch={true}>About us</Link>
                    <Link href="contactus" className="text-secondary hover:text-primary duration-500" prefetch={true}>Contact us</Link>
