...
const SecondCard = ({title, body}: cardProps) => {
    return ( 
        <main className="w-[30%] min-w-[20rem] h-60 rounded-lg group flex flex-col items-center p-4 border border-[#CDCED2] inter text-[#1C1F33] text-center hover:bg-primary duration-500">
